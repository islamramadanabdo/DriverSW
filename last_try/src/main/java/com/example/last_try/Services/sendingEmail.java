...
public class sendingEmail {
	...
	public static void send_trip_notification(User reciever, Trip new_trip ) throws Exception
    {
	...
	public static void send_offer_notification(User reciever, offer new_offer ) throws Exception
    {
